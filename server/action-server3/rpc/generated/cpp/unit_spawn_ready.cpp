...
namespace torikime::unit::spawn_ready
{
	...
	void Rpc::Responser::send(bool success, torikime::unit::spawn_ready::Response&& response)
	{
		torikime::unit::spawn_ready::ResponseParcel responseParcel;
	...
	void Rpc::onSpawnReadyRequest(const potato::net::protocol::Payload& payload)
	{
		torikime::unit::spawn_ready::RequestParcel requestParcel;
	...
	void Rpc::deserialize(const potato::net::protocol::Payload& payload, torikime::unit::spawn_ready::RequestParcel& outRequest)
	{
		outRequest.Clear();
