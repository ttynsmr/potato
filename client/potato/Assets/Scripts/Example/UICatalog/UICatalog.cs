...
namespace UICatalog {
	...
	public class UICatalogApp {
        ...
        private static bool _heightAsBuffer = true;//false;
		private static bool _alwaysSetPosition;
		private static bool _isFirstRunning = true;

        public static void Main(Action applicationInitializer)
        {
            ...
            //{
            //    var item = _scenarios.FindIndex(t => Scenario.ScenarioMetadata.GetName(t).Equals(senario, StringComparison.OrdinalIgnoreCase));
            ...
            Scenario scenario;
            while ((scenario = GetScenarioToRun(applicationInitializer)) != null)
            {
		...
		/// </summary>
		/// <returns></returns>
		private static Scenario GetScenarioToRun (Action applicationInitializer)
		{
			Application.UseSystemConsole = _useSystemConsole;
            //Application.Init ();
