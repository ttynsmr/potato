...
namespace UICatalog.Scenarios {
	...
	public class Scrolling : Scenario {
		...
		public override void Setup ()
		{
			...
			void Top_Loaded ()
			{
				horizontalRuler.Text = rule.Repeat ((int)Math.Ceiling ((double)(horizontalRuler.Bounds.Width) / (double)rule.Length)).Substring(0,(horizontalRuler.Bounds.Width)) +
				"\n" + "|         ".Repeat ((int)Math.Ceiling ((double)(horizontalRuler.Bounds.Width) / (double)rule.Length)).Substring(0, (horizontalRuler.Bounds.Width));
				verticalRuler.Text = vrule.Repeat ((int)Math.Ceiling ((double)(verticalRuler.Bounds.Height * 2) / (double)rule.Length)).Substring(0, (verticalRuler.Bounds.Height * 2));
